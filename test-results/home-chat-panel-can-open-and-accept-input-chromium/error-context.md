...
- Name: home.spec.js >> chat panel can open and accept input
- Location: tests\e2e\home.spec.js:20:1
...
Locator: locator('button').filter({ hasText: /Abrir chat|Ocultar chat/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('button').filter({ hasText: /Abrir chat|Ocultar chat/ })
